          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item ">
				...
				<br>
				<a href="cart.php" style="color:white" class="nav-link active">cart</a>
              </li>
            </ul>
          </div>
        </div>
...
$sql111="SELECT quantity FROM product where product_id='$prid'";
$result222=mysqli_query($conn,$sql111);
$abc=mysqli_fetch_assoc($result222);
$qt=$abc['quantity'];
  
  
  echo    "<img src='$path' width='50' height='80' style='float:left' alt='' />";
  echo  '</div>';
 
  echo  '<div class="description">';
  echo "<span style='width:400px'>$desc</span>";
 
  if($qt<$q)
  {
	  $flag=true;
	  echo "<br>";
	  echo "<span style='font-size:20px;color:red'>Currently Unavailable...</span>";
  }
  echo   '</div>';
  echo   "<a href='deletecartproduct.php?prid=$prid' class='filled-button' style='height:50px;margin-top:20px;margin-left:60px'>Delete</a>";
 
	//form  for quantity increase	
	$q1=$q+1;
	echo "<a href='quantitychange.php?quantity=$q1&prodid=$pid'  class='glyphicon glyphicon-plus add'></a>";
	echo " <input type='text' class='qty' id='qty' name='qty' style='margin-left:30px;margin-right:30px;' min='1' value='$q' onchange='qty()'> ";
	$q2=$q-1;
	if($q2>=1){
	echo "<a href='quantitychange.php?quantity=$q2&prodid=$pid'  class='glyphicon glyphicon-minus add1'></a>";;
	}
	echo "<input type='hidden' value='$price' name='pid' id='hprice$pid'>";
		
	echo  "<div class='total-price' style='padding-left:60px'  id='qtyxprice$pid'>".$q*$price."</div>";
...
$total=$totalprice;
 ...
 echo '<div class="contact-information">';
      echo '<div class="container">';
          ...
          echo '<li class="list-group-item">';
           echo ' <div class="row">';
             ...
             echo '     </div>';
              ...
              echo '         <strong style="font-size:20px">₹ '.$totalprice .'</strong>';
              echo '    </div>';
            echo ' </div>';
         echo ' </li>';
        ...
        echo '       <div class="row">';
           echo '         <div class="col-6">';
           echo '              <em>Delivery Charges</em>';
           echo '         </div>';

            echo '        <div class="col-6 text-right">';
            echo '             <strong style="font-size:15px">₹' ." 0 " .'</strong>';
            echo '        </div>';
            echo '   </div>';
         echo ' </li>';
         ...
         echo '           </div>';
          ...
          echo '          <div class="col-6 text-right">';
          echo '               <strong style="font-size:20px">₹ '.$total.'</strong>';
          echo '          </div>';
          echo '     </div>';
          echo '</li>';
         ...
         echo '           <div class="col-6">';
          ...
          echo '          <div class="col-6 text-right">';
		  if($total>40 && $flag==false){
				echo "  <strong> <a href='proceed_address.php' class='filled-button'>CHECKOUT</a></strong>";
		  }
          echo '          </div>';
         echo '      </div>';
        echo '  </li>'; 
