              ...
              <form id="contact" action="" method="get">
				...
				<!--  name -->
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="name12" type="text" class="form-control" id="name" placeholder=" Name" value="<?php echo $_SESSION['admin_name'];?>" required="">
                    </fieldset>
                  </div>
				  <!-- Phone number-->
				...
				<div class="d-flex justify-content-center">
					<div class="col-lg-6 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="phone_number12" type="text" class="form-control" id="phone_number" value="<?php echo "$phno";?>" placeholder="Phone Number" required="">
                    </fieldset>
                  </div>
				</div>
				...
				<div class="d-flex justify-content-center">
                  ...
                  <div class="col-lg-12 " style="margin-bottom:130px">
					<a  href="#" class='filled-button'>Update</a>
					  ...
					  <a href="index -admin.php" class="filled-button">Go to home Page</a>
